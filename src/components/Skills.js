...
const Skill = ({ name, x, y }) => {
  return (
    ...
    absolute dark:bg-light dark:text-dark lg:py-2 lg:px-4 md:text-sm md:py-1.5 md:px-3 xs:bg-transparent xs:dark:bg-transparent
  ...
  return (
    <>
      ...
      ">
        <motion.div
          whileHover={{ scale: 1.05 }}
          className="flex cursor-pointer items-center justify-center rounded-full font-semibold bg-dark text-light p-8 shadow-dark dark:bg-light dark:text-dark
