...
const projects = () => {
  return (
    <>
      <Head>
        <title>Keval | Project Page</title>
        ...
        <Layout className="pt-16">
          ...
          <div className="grid grid-cols-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0">
            <div className="col-span-12">
              <FeaturedProject
                img={project2}
                title="Experience Seaside Website"
                summary={`
                A modern, responsive Seaside Stay website using Next.js and Tailwind CSS. It features a visually rich landing page to showcase amenities, seaside views, and booking info with smooth scrolling and immersive design for vacation booking..
                `}
                link={"/"}
                github={"/"}
