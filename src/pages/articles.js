    ...
    <>
      <li className="col-span-1 w-full p-4 bg-light border border-solid border-dark rounded-2xl relative dark:bg-dark dark:border-light">
        ...
        <Link href={link} target="_blank">
          <h2 className="my-2 text-2xl font-bold capitalize hover:underline mt-4 xs:text-lg">
            {title}
          </h2>
...
const articles = () => {
  return (
    <>
      <Head>
        <title>Keval | Articles Page</title>
        <meta name="description" content="Articles Page" />
      </Head>
      <TransitionEffect />
      <main className="flex w-full mb-16 flex-col items-center overflow-hidden justify-center dark:text-light">
